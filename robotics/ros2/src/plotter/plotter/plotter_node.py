...
def main(args=None) -> None:
    ...
    # ---------------------------------------------------------------------
    # TThread for spin the node
    # https://realpython.com/intro-to-python-threading/
    spin_node_thread = threading.Thread(target = plotter_node.spin_node) # declared Thread
    spin_node_thread.setDaemon(True) # Set Daemon thread so it stops with main thread does
